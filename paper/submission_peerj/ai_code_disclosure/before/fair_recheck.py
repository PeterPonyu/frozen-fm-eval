...
DATA_ROOT=os.environ.get("DATA_ROOT","data/atlases")
LR={os.path.basename(f)[:-5]:f for f in glob.glob("expand_results/labeled_raw/*.h5ad")}
NATIVE={"GSE130148_lung":(os.path.join(DATA_ROOT,"DevelopmentDatasets2/GSE130148_LungHmDev.h5ad"),"celltype","orig.ident"),
        "GSE165784_retina":(os.path.join(DATA_ROOT,"DevelopmentDatasets2/GSE165784_RetinaHmDev.h5ad"),"cell_type","batch"),
        "lung24k":(os.path.join(DATA_ROOT,"DevelopmentDatasets/lung.h5ad"),"louvain","batch")}
