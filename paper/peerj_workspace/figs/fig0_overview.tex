...
\node[lane=cFM,minimum width=2.6cm,minimum height=0.7cm] (fm) at (3.05,1.7) {\transformer};
\node[stg=cFM,above=1pt of fm] {FOUNDATION MODEL};
\node[lane=cBase,minimum width=2.6cm,minimum height=0.7cm] (bl) at (3.05,-0.6)
...
\node[draw=black!30,rounded corners=2pt,minimum size=0.7cm] (fu) at (5.45,1.7) {\umap{0.9}};
\node[draw=black!30,rounded corners=2pt,minimum size=0.7cm] (bu) at (5.45,-0.6) {\umap{0.9}};
