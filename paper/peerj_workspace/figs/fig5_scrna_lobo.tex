...
\end{scope}
\begin{scope}
\path[clip] (357.75, 50.52) rectangle (460.76,214.47);
\definecolor{fillColor}{RGB}{255,255,255}
...
\end{scope}
\begin{scope}
\path[clip] (357.75,214.47) rectangle (460.76,229.18);
\definecolor{drawColor}{gray}{0.20}
\definecolor{fillColor}{gray}{0.85}
...
\node[text=drawColor,rotate= 90.00,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.90] at ( 11.20,132.49) {LOBO macro-AUROC};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (469.75,274.63);
\definecolor{fillColor}{RGB}{255,255,255}
